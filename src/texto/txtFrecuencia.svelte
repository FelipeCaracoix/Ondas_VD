...
<p style="font-size: larger">La frecuencia de una onda se define como el número de ciclos completos que ocurren en un segundo, y se mide en Hertz (Hz). En términos matemáticos, es la inversa del período (T), que es el tiempo que tarda en completarse un ciclo. 
</p>
